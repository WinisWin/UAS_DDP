...
int main(){
	...
	enum option{CREATE = 1, READ, MEAN, RECOMEND, PRESTASI ,FINISH};
	...
	while(pilihan != FINISH){
		...
		switch(pilihan){
            ...
            if(a>80){
                for(int i=0;i<1;i++){
                    cout << nama[i]<<" adalah siswa berprestasi \n";
                }
            }else{
                cout << "tidak ada \n";
            }
...
int getOption(){
	...
	cout << "5. Tampilkan termasuk berprestasi \n" ;
	cout << "6. Selesai \n" ;
	cout << "=============================== \n" ;
	cout << "pilih [1-6]? : ";
	cin >> input;
